...
const Banner = () => {
  return (
    <div className="dark:bg-gray-950">
      ...
      >
        <div className="max-w-7xl mx-5 md:mx-10 xl:mx-auto h-[85vh]  flex flex-col-reverse md:flex-row justify-center md:justify-between items-center gap-6 md:gap-0 text-white text-center md:text-start">
